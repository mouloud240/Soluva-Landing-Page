    ...
    cases: [
      {
        ...
        stat: "2× conversion in 3 months",
        detail: "Optimized checkout & performance",
      },
      {
        title: "IoT Security Platform",
        stat: "30m → 5m response time",
        detail: "Event pipeline & alerting",
      },
      {
        title: "Task App",
        stat: "1k → 100k users, zero downtime",
        detail: "Horizontal scaling & caching",
      },
    ],
    whyTiles: [
    ...
    cases: [
      {
        ...
        stat: "2× de conversion en 3 mois",
        detail: "Checkout optimisé & performance",
      },
      {
        title: "Plateforme sécurité IoT",
        stat: "30m → 5m temps de réponse",
        detail: "Pipeline d’événements & alerting",
      },
      {
        title: "Application de tâches",
        stat: "1k → 100k utilisateurs, zéro downtime",
        detail: "Scalabilité horizontale & cache",
      },
    ],
    whyTiles: [
      {
    ...
    cases: [
      {
        ...
        stat: "×2 في التحويل خلال 3 أشهر",
        detail: "تحسين مسار الدفع والأداء",
      },
      {
        title: "منصة أمن إنترنت الأشياء",
        stat: "30 دقيقة → 5 دقائق زمن الاستجابة",
        detail: "خط أنابيب للأحداث وتنبيه",
      },
      {
        title: "تطبيق مهام",
        stat: "1k → 100k مستخدم دون توقف",
        detail: "توسّع أفقي وتخزين مؤقت",
      },
    ],
    whyTiles: [
